  ...
  describe 'GET /index' do
    context 'without a current user' do
      ...
      it 'redirects to login page' do
        get account_calls_path(account_with_user.account)
    ...
    context 'with multiple accounts' do
      ...
      let!(:call) { create(:call, twilio_account: account_with_user.twilio_accounts.first) }
      let!(:other_call) { create(:call, twilio_account: other_account_with_user.twilio_accounts.first) }
      ...
      it 'only shows calls from first account' do
        get account_calls_path(account_with_user.account)
        expect(response.body).to include(call.sid)
          .and not_include(other_call.sid)
      end
    end
  end
end
