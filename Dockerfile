...
ARG PROD_PACKAGES="postgresql-client file vim curl gzip libsqlite3-0 supervisor"
...
RUN IGNORE_MISSING_SECRETS=true DATABASE_URL=postgres://localhost:5432 rake assets:precompile
